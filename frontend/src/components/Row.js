...
function Row(props) {
    ...
    return(
        ...
        <RowsStyleExtension>
            {props.boardIndex === 0 &&
                <RowSide>
                    <ToggleButton style={{ width: "227px", marginLeft: "10px", marginTop: "10px", height:"50"}} onLabel={props.name} offLabel={props.name} onIcon="pi pi-minus" offIcon="pi pi-plus"
                                  checked={!props.isCollapsed} onChange={props.isCollapsed ?  () => handleExpand() :  () => handleCollapse()} />
                </RowSide>
            }
            {!props.isCollapsed &&
            <RowCollapsable>
