      ...
      <LoginPage>
          ...
          <div className="surface-card p-6 shadow-5 border-round w-full lg:w-4">
              <div className="text-center mb-5">
                  <div className="text-700 text-3xl font-medium mb-3">Witaj, proszę wpisz dane użytkownika:</div>
                  <span className="text-500 font-large line-height-3">By założyć konto kliknij</span>
                  <a className="font-medium no-underline ml-2 text-blue-500 cursor-pointer">tutaj</a>
              </div>
